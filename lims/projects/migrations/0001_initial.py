    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_identifier', models.CharField(max_length=20, default='', db_index=True)),
                ...
                ('optimised_for', models.ForeignKey(null=True, blank=True, to='shared.Organism')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_identifier', models.CharField(max_length=20, default='')),
                ('order', models.ForeignKey(null=True, to='orders.Order', blank=True, related_name='associated_projects')),
